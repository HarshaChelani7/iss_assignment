...
public class CollectionsDemo {
    ...
    public static void main(String[] args) {
        ...
        Student johnDoe = new Student(1, "John Doe", 94);
        Student janeDoe = new Student(2, "Jane Doe", 86);
        Student jennyDoe = new Student(3, "Jenny Doe", 56);
        Student jackDoe = new Student(4, "Jack Doe", 72);
        Student jimmyDoe = new Student(5, "Jimmy Doe", 83);

        SortByPercentage sortByPercentage = new SortByPercentage();
        ...
        displayCollection(studentArrayList);
        Collections.sort(studentArrayList, sortByPercentage);
        ...
        studentLinkedList.add(jimmyDoe);
        ...
        displayCollection(studentLinkedList);
        Collections.sort(studentLinkedList, sortByPercentage);
        ...
        displayCollection(studentVector);
        Collections.sort(studentVector, sortByPercentage);
        ...
        displayCollection(studentStack);
        Collections.sort(studentStack, sortByPercentage);
        ...
        studentLinkedHashSet.add(jimmyDoe);
        ...
        studentLinkedHashMap.put(5, jimmyDoe);
