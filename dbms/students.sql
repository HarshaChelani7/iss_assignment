...
("John","Doe",987654321,"95.09",1),
("Jane","Doe",887954321,"85.19",2),
("Jimmy","Doe",775254321,"55.95",3),
("Jack","Doe",987665526,"75.09",2),
("Jenny","Doe",987654000,"69.18",1);
...
-- wildcard operator
Select * from student where student.first_name like "J%";
Select * from student where student.first_name like "S%e";
Select * from student where student.first_name like "J___";
